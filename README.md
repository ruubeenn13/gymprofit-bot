...
- **Trabajo y tienda:** `/trabajo` (lista · elegir · currar · ascender · carrera · dimitir) ·
  `/empresa` (fundar · info · disolver · invitar · solicitar · pendientes · rango · sacar · despedir · propuestas · mejorar · ascender · ranking · vender) · `/empleo` (ver · contratar) · `/tienda` · `/comprar` ·
