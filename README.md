...
| `/ejercicio-dia` | El ejercicio elegido para hoy, con su frase motivadora (el bot lo publica solo cada día a las 8:00 en el canal configurado) |
...
**Moderación:** `/warn` (poner · lista · quitar · limpiar) escala a timeout/ban y avisa por DM al
sancionado; el bot tiene **anti-flood y anti-invites propios** (borra + avisa) y las infracciones
del **AutoMod nativo de Discord también cuentan** para el mismo escalado; `/setup` deja listo el
panel de tickets fijado en `🎫・soporte`.
