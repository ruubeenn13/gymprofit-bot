...
/** {@code /depositar <coins>}: mueve coins del monedero al ahorro del banco. */
public final class DepositarComando implements Comando {

    private static final String NOMBRE = "depositar";

    private final BancoService banco;

    public DepositarComando(BancoService banco) {
        this.banco = banco;
    }
    ...
    public SlashCommandData definicion() {
        ...
        return Commands.slash(NOMBRE, Messages.get(Messages.ES, "comando.depositar.descripcion"))
                .setDescriptionLocalization(DiscordLocale.SPANISH,
                        Messages.get(Messages.ES, "comando.depositar.descripcion"))
                .setDescriptionLocalization(DiscordLocale.ENGLISH_US,
                        Messages.get(Messages.EN, "comando.depositar.descripcion"))
    ...
    public void ejecutar(SlashCommandInteractionEvent evento) {
        ...
        Resultado r = banco.depositar(evento.getUser().getIdLong(), cantidad);
