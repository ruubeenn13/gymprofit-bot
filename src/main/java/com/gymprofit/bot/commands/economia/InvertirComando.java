...
/** {@code /invertir <accion> <cantidad>}: compra acciones al precio actual (con comisión). */
public final class InvertirComando implements Comando {

    private static final String NOMBRE = "invertir";

    private final BolsaService bolsa;

    public InvertirComando(BolsaService bolsa) {
        this.bolsa = bolsa;
    }
    ...
    public SlashCommandData definicion() {
        ...
        return Commands.slash(NOMBRE, Messages.get(Messages.ES, "comando.invertir.descripcion"))
                .setDescriptionLocalization(DiscordLocale.SPANISH,
                        Messages.get(Messages.ES, "comando.invertir.descripcion"))
                .setDescriptionLocalization(DiscordLocale.ENGLISH_US,
                        Messages.get(Messages.EN, "comando.invertir.descripcion"))
