...
_Ejemplo:_ `EjercicioDelDiaJob` publica a las 08:00 `Europe/Madrid` un ejercicio del catálogo.
...
_Example:_ `EjercicioDelDiaJob` posts a catalog exercise at 08:00 `Europe/Madrid`.
